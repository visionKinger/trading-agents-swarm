...
|---|---|
| Orchestrator | This file (`AGENTS.md`) |
| Sub-agents | `.github/agents/*.md` |
...
- **To add a new analyst:** create `.github/agents/<name>.md`, then wire it into the pipeline above
